...
import { Box, Button, Container, Group, NumberInput, SegmentedControl, Stack, TextInput, Title } from '@mantine/core';
      ...
      <Stack>
        ...
        <Group wrap='nowrap'>
          ...
          <NumberInput
            ...
            onChange={(v) => setState((s) => ({ ...s, floorTotal: Number.isFinite(v as number) ? (v as number) : '' }))}
            min={0}
          />
        </Group>
        <NumberInput
