import { Accordion, ActionIcon, Avatar, Button, Group, Menu, Modal, Space, Stack, Text } from '@mantine/core';
...
import { propertyDataProvider } from '../../../data/data-providers/property';
